/*
An exact copy of nuklear_sdl_gl3.h from Nuklear/demo/sdl_opengl3, except the
SDL includes have been fixed. (SDL.h instead of SDL2/SDL.h)
I can't just make commits to the submodule because I don't have write access to
the repo it's tied to, and I don't want to fork nuklear just to make one tiny
change, so this is all I can do for now.
*/
/*
